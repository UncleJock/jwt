...
abstract class JWTBase implements JWT
{
     ...
     * @return string
     */
    abstract public static function encode(array $header, array $payload, string $key): string;
     ...
     * @return object
     */
    abstract public static function decode(string $jwt_token, string $key): object;
     ...
     * @return string
     */
    protected static function jsonEncode($input): string
    {
     ...
     * @param $errMsg
     */
    protected static function handleJsonError($errMsg): void
    {
        $messages = [
        ...
        throw new DomainException(
            $messages[$errMsg] ?? 'Unknown JSON error: '.$errMsg
        );
    }
